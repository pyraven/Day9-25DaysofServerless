...
A user opens an issue which triggers the Cloud Function to reply with a holiday theme message. The environment variable is for an oauth token created under https://github.com/settings/developers.